const rules = [
	...
	['인사 또는 급여 정보', /\b(?:salary|payroll|compensation|human resources)\b|급여|연봉|인사정보/iu],
	['직원 식별 정보', /\b(?:employee|staff)\s*(?:id|no\.?|number)\s*[:#-]?\s*[a-z0-9-]{3,}\b|사번\s*[:#-]?\s*[a-z0-9-]+/iu],
	['개인 연락처', /(?:\+?82[- .]?)?0?1[016789][- .]?\d{3,4}[- .]?\d{4}|[\w.+-]+@[\w.-]+\.[a-z]{2,}/iu],
	['주민등록번호', /\b\d{6}-[1-4]\d{6}\b/u]
];
